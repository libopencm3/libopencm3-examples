...
// struct txtinfo: text attribites
struct txtinfo {
	const uint8_t *font;
	int f_hight;
	int f_size;
...
void lcd_rectangle(int x1, int y1, int x2, int y2, int color);
...
#define FRAME_BUFFER ((uint16_t *)0xd0000000)
#define LCD_WIDTH 240
#define LCD_HIGHT 320

/* These names are used in STM32Cube and in ILI9341 manual */
/** 
